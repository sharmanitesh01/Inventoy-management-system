...
// Fake monthly trend data for chart (in real app, comes from backend)
const trendData = [
...
function Dashboard() {
  ...
  // Fetch stats when component first loads
  useEffect(() => {
    fetchStats();
  }, []);
  ...
  // Build pie chart data from backend category data
        ...
        <div className="card chart-card">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={trendData}>
              ...
              <Tooltip
                contentStyle={{ background: '#0d1b35', border: '1px solid #1e3a6e', borderRadius: '10px', color: '#e2e8f0' }}
              />
